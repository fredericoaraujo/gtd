...
class LabelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create label" do
    assert_difference("Label.count") do
      post labels_url, params: { label: { color: @label.color, name: @label.name, user_id: @label.user_id } }
    end
  ...
  test "should update label" do
    patch label_url(@label), params: { label: { color: @label.color, name: @label.name, user_id: @label.user_id } }
